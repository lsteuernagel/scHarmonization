...
# make folder:
harmonization_scvi_folder = paste0(param_set$harmonization_folder_path,"scvi/")
system(paste0("mkdir -p ",paste0(harmonization_scvi_folder)))
...
param_set$categorical_covariates = c("Dataset",param_set$batch_var)
