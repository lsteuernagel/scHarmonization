...
hypoMap_seurat@meta.data$Author_Class_Curated[hypoMap_seurat@meta.data$seurat_clusters=="122"] = "Fibroblast"
hypoMap_seurat@meta.data$Author_Class_Curated[hypoMap_seurat@meta.data$seurat_clusters=="146"] = "Differentiating"
hypoMap_seurat@meta.data$Author_Class_Curated[hypoMap_seurat@meta.data$seurat_clusters=="198"] = "CHECK"
hypoMap_seurat@meta.data$Author_Class_Curated[hypoMap_seurat@meta.data$seurat_clusters=="201"] = "Doublet"
hypoMap_seurat@meta.data$Author_Class_Curated[hypoMap_seurat@meta.data$seurat_clusters=="202"] = "Doublet"
hypoMap_seurat@meta.data$Author_Class_Curated[hypoMap_seurat@meta.data$seurat_clusters=="203"] = "Doublet"
hypoMap_seurat@meta.data$Author_Class_Curated[hypoMap_seurat@meta.data$seurat_clusters=="204"] = "CHECK"
hypoMap_seurat@meta.data$Author_Class_Curated[hypoMap_seurat@meta.data$seurat_clusters=="205"] = "Doublet"

hypoMap_seurat@meta.data$Author_Class_Curated[hypoMap_seurat@meta.data$seurat_clusters=="23"] = "Astrocytes"
