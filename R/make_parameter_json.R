...
# pruning:
param_list$run_additional_gene_removal =TRUE # whether to run an additional check on imbalanced genes and exclude them from markers for pruning
...
param_list$min_sibling_markers = 10 # how many sibling markers are required to not merge
