mrtree_res = readRDS("/beegfs/scratch/bruening_scratch/lsteuernagel/data/hypoMap_v2_harmonization_test/hypoMap_test_curated_curated_mrtree_res_raw.rds")
...
plot_cluster_tree(edges,level_pattern = "K[0-9]+",leaf_level = "K144")
