...
overview_clustering = mapscvi::compare_clustering(query_seura_object = subset_seurat,
                                                  ...
                                                  clustering_2 = "leiden_clusters_27",
                                                  min_cells = 5,
                                                  min_pct = 0.05,
                                                  return_data=TRUE)
# sankey
# i focus on the vmh part of the clusters
clustering_2_filter = unique(subset_seurat@meta.data$leiden_clusters_27[subset_seurat@meta.data$leiden_clusters_0.05 == "3"]) # neurons only
